...
const CategoryInput = ({
  ...
  const setDatas = () => {
    ...
    if (tab === "income") {
      setFilteredCategories(incomeCategory);
    }
    if (tab === "expense") {
      setFilteredCategories(expenseCategory);
    }
  };
  ...
  return (
    <div className='relative w-full col-span-12'>
      ...
      <div className='relative'>
        ...
        <div
          onClick={handleSave}
          className='absolute cursor-pointer right-2 -translate-y-1/2 top-1/2 bg-incomes text-white p-2 rounded-lg'
        >
          Ekle
        </div>
      </div>
